...
# Carga de plugins de Oh My Zsh (asegúrate de que esta sección esté configurada así)
...
alias colorscript="bash /home/kamilo/scripts/shell-color-scripts/colorscript.sh -r"
bash /home/kamilo/scripts/shell-color-scripts/colorscript.sh -r
    # Define alias para fnf y fcf
alias fnf='nvim -o $(fzf)'
alias fcf='cat $(fzf)'
alias fxf='catn $(fzf)'
alias pwc='find . -type f | fzf | xargs -I{} realpath {} | xclip -selection clipboard'
alias pud='pwd | xclip -selection clipboard'
alias docd='docker-compose down'
alias docup='docker-compose up'
alias docp='docker-compose up -d'
alias cly='xclip -selection clipboard' 
alias error='/home/kamilo/scripts/yo/clip.sh'
# To customize prompt, run `p10k configure` or edit ~/.p10k.zsh.
#
[[ ! -f ~/.p10k.zsh ]] || source ~/.p10k.zsh
alias linux="/home/kamilo/programming/linux"
export PATH=$PATH:/usr/bin/nvim/bin
export VISUAL=vim;
export EDITOR=vim;
# camilo
# FLUTTER
export PATH="$PATH:/home/kamilo/flutter/bin"
# charp
export PATH=$PATH:/usr/local/share/dotnet

# Configura JAVA_HOME para Java 17
export JAVA_HOME=/usr/lib/jvm/java-17-openjdk-amd64
#configure varialbes de entorno java 
export PATH=$JAVA_HOME/bin:$PATH
# configuracion de vmware
